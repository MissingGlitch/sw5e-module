import BaseConfigSheet from "system/dnd5e/module/applications/actor/api/base-config.mjs";
...
export default class ActorCastPointsConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "module/sw5e/templates/actors/config/cast-points-config.hbs",
      width: 320,
      height: "auto",
      sheetConfig: false
    });
